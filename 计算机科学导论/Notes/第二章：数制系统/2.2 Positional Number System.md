...
* Largest 6-digit decimal = 999,999
* Largest 19-bit binary number = $2^{19} - 1 = 524,287$ ❌ too small
* Largest 20-bit binary number = $2^{20} - 1 = 1,048,575$ ✅ fits
...
Would you like a **code snippet** in Python or Java to automate this calculation?
